(function () {
  ...
  var DEFAULTS = {
    ...
    greeting: "Hi there! 👋 Ask me anything about our products or services.",
    timeoutMs: 45000,
    primaryColor: "#5048E5",
  };
  ...
  var CSS = [
    ...
    ".asw-header{display:flex;align-items:center;justify-content:space-between;padding:15px;background:linear-gradient(135deg,var(--asw-primary),#7c3aed);color:#fff}",
    ...
    ".asw-close{width:30px;height:30px;border:1px solid #ffffff3d;border-radius:50%;background:#ffffff24;color:#fff;display:grid;place-items:center;cursor:pointer}.asw-close svg{width:16px;height:16px;fill:none;stroke:currentColor;stroke-width:2.2;stroke-linecap:round}",
    ".asw-messages{flex:1;min-height:0;display:flex;flex-direction:column;gap:10px;overflow:auto;padding:16px 12px 10px}",
  ...
  class AISupportWidget {
    ...
    mount() {
      ...
      root.innerHTML =
        ...
        '" aria-hidden="true">' +
        '<header class="asw-header"><div class="asw-heading"><div class="asw-avatar">AI</div><div><div class="asw-title"></div><div class="asw-subtitle"></div></div></div><button class="asw-close" type="button" aria-label="Close chat">' +
        ICONS.close +
        '</button></header>' +
        ...
        '<div class="asw-suggestions"><button type="button" data-message="What can you help me with?">What can you help with?</button><button type="button" data-message="I have a question about your products.">Products</button></div>' +
    ...
    async send() {
      ...
      try {
        var answer = await this.callBackend(message, this.history.slice(-8));
